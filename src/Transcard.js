  ...
  return (
    <div class='p-2  md:p-0 lg:p-2 xl:py-4'>
        ...
        <table class='mx-2 '>
            ...
            <td class="pl-0 md:pl-4 lg:pl-0 xl:pl-0 "><img src={checkbox} alt='check box' class='w-3 h-3'></img></td>
            <td class='pl-2 md:pl-0 md:pr-4 lg:pl-0 lg:pr-0 xl:px-1'>All Invoices</td>
            <td class='pl-3  md:pl-4 lg:pl-8 xl:pl-20'>Status</td>
            <td class='pl-6 md:pl-6 lg:pl-8 xl:pl-20'>Amount</td>
            ...
            <td class='pl-6 md:pl-2 lg:pl-8 xl:pl-16'>Actions</td>
                ...
                {trans.map((transaction)=>{
                    return(
                            <tr key={transaction.id} class='text-xs leading-6 border-b-2 md:leading-8 lg:leading-9 xl:leading-10'>
                        ...
                        <td class='pl-3 md:pl-3 lg:pl-6 xl:pl-20'>{transaction.Amount}</td>
