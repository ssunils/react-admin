...
const Acard =() =>{
        return(
          ...
          <div class=''>
          <img src={ATM_Card} alt="ATM Card" class="mb-4 h-36 w-full md:h-28 lg:h-24 xl:h-36"></img>
          <p class='text-xs mr-52 md:mr-2 lg:mr-10 xl:mr-36 inline text-black'>{data.text}</p>
